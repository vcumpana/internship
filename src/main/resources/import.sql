...
insert into service (description, price, title, category_id) values('mobile telephony', 234, 'telephony', 1),('internet broadband', 234, 'FiberLink', 2),('Monney short-time loans ', 234, 'Microcredit', 3),('daily meals', 234, 'Meals', 4),('hotel booking', 234, 'Hotel Boking', 5),('flytickets booking', 234, 'FlyTickets', 6),('sms service', 234, 'sms', 1);
