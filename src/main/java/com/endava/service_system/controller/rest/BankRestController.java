...
public class BankRestController {
    ...
    public ResponseEntity addMoneyToBankAccount(@RequestBody Map<String,Object> data){
        ...
        return restTemplate.postForEntity( bankApi+"bankaccount/addmoney", request , String.class );
    };
    ...
    public ResponseEntity<BalanceDto> getBalance(){
        ...
        return restTemplate.postForEntity( bankApi+"bankaccount/balance", request , BalanceDto.class );
    };
